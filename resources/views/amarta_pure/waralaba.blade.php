                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                            <div class="widget widget_img_gellary clearfix">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{url('landing_page')}}/images/portfolio/portofolio_4.png" rel="prettyPhoto[coregallery]" data-rel="prettyPhoto">
                                            <img style="height: 90px; width: 90px;" class="img-fluid" src="{{url('landing_page')}}/images/portfolio/portofolio_4.png" alt=""></a>
                                    </li>
                                    <li><a href="{{url('landing_page')}}/images/portfolio/portofolio_5.png" rel="prettyPhoto[coregallery]" data-rel="prettyPhoto">
                                            <img style="height: 90px; width: 90px;" class="img-fluid" src="{{url('landing_page')}}/images/portfolio/portofolio_5.png" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
