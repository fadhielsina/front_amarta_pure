...
<body>
    ...
    <div class="page">
        ...
        <div class="site-main">
            ...
            <!--about-section-->
            <section class="ttm-row about-section clearfix" style="padding-top: 50px;">
                <div class="container">
                    <!-- row -->
                            ...
                            <div class="margin_top15 res-991-margin_top50">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>ABOUT US</h3>
                                        <h2 class="title">Perusahaan PT. Jagat Tirta Amarta</h2>
                                    </div>
                                ...
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-rounded ttm-btn-style-border ttm-btn-color-dark  margin_top15" href="about-us">read more</a>
                ...
                <div class="container P-0">
                    <div class="row">
                        <div class="col-xl-11 col-lg-11 col-md-11">
                            <!-- section title -->
                            <div class="section-title style2 without-sep">
